...
def run_test_sum_of_digits():
    ...
    # Test 3:
    expected = 11
    answer = sum_of_digits(1208)
    print('Test 3 expected:', expected)
    print('       actual:  ', answer)

    # Test 4:
    expected = 1
    answer = sum_of_digits(2*5)
    print('Test 4 expected:', expected)
    print('       actual:  ', answer)

    # Test 5:
    expected = 23
    answer = sum_of_digits(55553)
    print('Test 5 expected:', expected)
    print('       actual:  ', answer)

    # Test 6:
    expected = 10
    answer = sum_of_digits(4*4*4)
...
def fancy_sums_of_digits(n):
    ...
    """
    # -------------------------------------------------------------------------
    # : 8. Implement and test this function.
